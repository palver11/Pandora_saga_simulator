...
//   alert(tmp);
  switch (tmp) {
    case 43:  StatusMove('Lev',1);          CalcSet('Lev'); break; // [+] level+1
    case 45:  StatusMove('Lev',-1);         CalcSet('Lev'); break; // [-] level-1
    case 113: StatusMove('Status','STA',1); CalcSet('STA'); break; // [q] Physical strength+1
    case 81:  StatusMove('Status','STA',-1);CalcSet('STA'); break; // [Q] Physical strength-1
    case 119: StatusMove('Status','STR',1); CalcSet('STR'); break; // [w] Strength+1
    case 87:  StatusMove('Status','STR',-1);CalcSet('STR'); break; // [W] Strength-1
    case 101: StatusMove('Status','AGI',1); CalcSet('AGI'); break; // [e] agile+1
    case 69:  StatusMove('Status','AGI',-1);CalcSet('AGI'); break; // [E] agile-1
    case 114: StatusMove('Status','DEX',1); CalcSet('DEX'); break; // [r] Dexterous+1
    case 82:  StatusMove('Status','DEX',-1);CalcSet('DEX'); break; // [R] Dexterous-1
    case 116: StatusMove('Status','SPR',1); CalcSet('SPR'); break; // [t] inspiration+1
    case 84:  StatusMove('Status','SPR',-1);CalcSet('SPR'); break; // [T] inspiration-1
    case 121: StatusMove('Status','INT',1); CalcSet('INT'); break; // [y] Intellectuality+1
    case 89:  StatusMove('Status','INT',-1);CalcSet('INT'); break; // [Y] Intellectuality-1
    case 97:  CalcSet('Skill',1,1,'Adeptness');             break; // [a] kill+1
    case 65:  CalcSet('Skill',1,-1,'Adeptness');            break; // [A] kill-1
    case 115: CalcSet('Skill',2,1,'Adeptness');             break; // [s] poke+1
    case 83:  CalcSet('Skill',2,-1,'Adeptness');            break; // [S] poke-1
    case 100: CalcSet('Skill',3,1,'Adeptness');             break; // [d] pay+1
    case 68:  CalcSet('Skill',3,-1,'Adeptness');            break; // [D] pay-1
    case 102: CalcSet('Skill',4,1,'Adeptness');             break; // [f] Blow+1
    case 70:  CalcSet('Skill',4,-1,'Adeptness');            break; // [F] Blow-1
    case 103: CalcSet('Skill',5,1,'Adeptness');             break; // [g] defense+1
    case 71:  CalcSet('Skill',5,-1,'Adeptness');            break; // [G] defense-1
    case 122: CalcSet('Skill',7,1,'Adeptness');             break; // [z] shooting+1
    case 90:  CalcSet('Skill',7,-1,'Adeptness');            break; // [Z] shooting-1
    case 120: CalcSet('Skill',8,1,'Adeptness');             break; // [x] Formation+1
    case 88:  CalcSet('Skill',8,-1,'Adeptness');            break; // [X] Formation-1
    case 99:  CalcSet('Skill',9,1,'Adeptness');             break; // [c] assassination+1
    case 67:  CalcSet('Skill',9,-1,'Adeptness');            break; // [C] assassination-1
    case 118: CalcSet('Skill',10,1,'Adeptness');            break; // [v] Device+1
    case 86:  CalcSet('Skill',10,-1,'Adeptness');           break; // [V] Device-1
    case 98:  CalcSet('Skill',11,1,'Adeptness');            break; // [b] Avoidance+1
    case 66:  CalcSet('Skill',11,-1,'Adeptness');           break; // [B] Avoidance-1
    case 104: CalcSet('Skill',13,1,'Adeptness');            break; // [h] love+1
    case 72:  CalcSet('Skill',13,-1,'Adeptness');           break; // [H] love-1
    case 106: CalcSet('Skill',14,1,'Adeptness');            break; // [j] bless+1
    case 74:  CalcSet('Skill',14,-1,'Adeptness');           break; // [J] bless-1
    case 107: CalcSet('Skill',15,1,'Adeptness');            break; // [k] Exorcism+1
    case 75:  CalcSet('Skill',15,-1,'Adeptness');           break; // [K] Exorcism-1
    case 108: CalcSet('Skill',16,1,'Adeptness');            break; // [l] chant+1
    case 76:  CalcSet('Skill',16,-1,'Adeptness');           break; // [L] chant-1
    case 110: CalcSet('Skill',18,1,'Adeptness');            break; // [n] element+1
    case 78:  CalcSet('Skill',18,-1,'Adeptness');           break; // [N] element-1
    case 109: CalcSet('Skill',19,1,'Adeptness');            break; // [m] Embodiment+1
    case 77:  CalcSet('Skill',19,-1,'Adeptness');           break; // [M] Embodiment-1
    case 44:  CalcSet('Skill',20,1,'Adeptness');            break; // [,] Darkness+1
    case 60:  CalcSet('Skill',20,-1,'Adeptness');           break; // [<] Darkness-1
    case 46:  CalcSet('Skill',21,1,'Adeptness');            break; // [.] Confuse+1
    case 62:  CalcSet('Skill',21,-1,'Adeptness');           break; // [>] Confuse-1
    case 47:  CalcSet('Skill',23,1,'Adeptness');            break; // [/] Race+1
    case 63:  CalcSet('Skill',23,-1,'Adeptness');           break; // [?] Race-1
    case 92:  CalcSet('Skill',24,1,'Adeptness');            break; // [\] Riding+1
    case 95:  CalcSet('Skill',24,-1,'Adeptness');           break; // [_] Riding-1
  }
}
// -------------------------------------------------------------------------------------------
function Reset(a) {
...
function StatusMove(a,b,c,event) {
  ...
  switch (a) {
    case 'Lev':
      tmp[0] = (b > 0) ? '+': '-';
      if (tmp[0] == '-') b *= -1; // Convert negative value correctly
    ...
    case 'Status':
      tmp[0] = (c > 0) ? '+': '-';
      if (tmp[0] == '-') c *= -1; // Convert negative value correctly
      for (i=0;i<c;i++) {
        if (tmp[0] == '+') {
